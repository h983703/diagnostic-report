...
public class KomplexVerAdapter  extends RecyclerView.Adapter<KomplexVerAdapter.ViewHolder> {
    ...
    KomplexVerAdapter (Context context, ArrayList<Jelentes> jelentesek){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.list_ver_item, parent, false));
    }

    @Override
    public void onBindViewHolder( KomplexVerAdapter.ViewHolder holder, int position) {
